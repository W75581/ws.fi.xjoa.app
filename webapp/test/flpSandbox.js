					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TAX XJOA Process",
									"targetURL": "#wsfixjoaapp-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"wsfixjoaapp-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ws.fi.xjoa.app",
									"url": sap.ui.require.toUrl("ws/fi/xjoa/app")
								}
							}
						}
					}
